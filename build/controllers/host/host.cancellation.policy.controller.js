...
exports.HostCancellationPolicyController = void 0;
...
let CancellationPolicyClass = class CancellationPolicyClass extends _baseController_1.default {
    ...
    async getAllPolicies(req, res, next) {
        try {
            ...
            let data = await _entity_1.CancellationPolicyV1.getAllCancellationPolicyForHost(payload);
...
CancellationPolicyClass = __decorate([
    swagger_express_ts_1.ApiPath({
        path: "/api/host/cancellationPolicy",
        name: "Host Cancellation Module",
        security: { apiKeyHeader: [] },
    }),
    __metadata("design:paramtypes", [])
], CancellationPolicyClass);
exports.HostCancellationPolicyController = new CancellationPolicyClass();
//# sourceMappingURL=host.cancellation.policy.controller.js.map