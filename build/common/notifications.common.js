...
async function notificationPayload(data, bookingId) {
    return {
        TYPE: {
            BOOKING_SUCCESS: enum_common_1.ENUM.NOTIFICATION_TYPE.BOOKING_SUCCESS_USER,
            BOOKING_SUCCESS_HOST: enum_common_1.ENUM.NOTIFICATION_TYPE.BOOKING_SUCCESS_HOST,
            BOOKING_REQUEST_HOST: enum_common_1.ENUM.NOTIFICATION_TYPE.BOOKING_REQUEST_HOST,
            BOOKING_REQUEST_USER: enum_common_1.ENUM.NOTIFICATION_TYPE.BOOKING_REQUEST_USER,
            BOOKING_REQUEST_ACCEPTED_HOST: enum_common_1.ENUM.NOTIFICATION_TYPE.BOOKING_REQUEST_ACCEPTED_HOST,
            BOOKING_REQUEST_ACCEPTED_USER: enum_common_1.ENUM.NOTIFICATION_TYPE.BOOKING_REQUEST_ACCEPTED_USER,
            BOOKING_REQUEST_REJECTED_HOST: enum_common_1.ENUM.NOTIFICATION_TYPE.BOOKING_REQUEST_REJECTED_HOST,
            BOOKING_REQUEST_REJECTED_USER: enum_common_1.ENUM.NOTIFICATION_TYPE.BOOKING_REQUEST_REJECTED_USER,
            BOOKING_CANCELLED_USER: enum_common_1.ENUM.NOTIFICATION_TYPE.BOOKING_CANCELLED_USER,
            BOOKING_CANCELLED_HOST: enum_common_1.ENUM.NOTIFICATION_TYPE.BOOKING_CANCELLED_HOST,
            USER_PB_VERIFICATION_SUCCESS: enum_common_1.ENUM.NOTIFICATION_TYPE.USER_PB_VERIFICATION_SUCCESS,
            USER_PB_VERIFICATION_FALSE: enum_common_1.ENUM.NOTIFICATION_TYPE.USER_PB_VERIFICATION_FALSE,
            USER_SCHEDULED_DEMO: enum_common_1.ENUM.NOTIFICATION_TYPE.SCHEDULED_DEMO,
            HOST_SCHEDULED_DEMO: enum_common_1.ENUM.NOTIFICATION_TYPE.SCHEDULED_DEMO,
            HOST_SCHEDULED_DEMO_STATUS_ACCEPT: enum_common_1.ENUM.NOTIFICATION_TYPE.SCHEDULED_DEMO,
            HOST_SCHEDULED_DEMO_STATUS_REJECT: enum_common_1.ENUM.NOTIFICATION_TYPE.SCHEDULED_DEMO,
            USER_SCHEDULED_DEMO_STATUS_REJECT: enum_common_1.ENUM.NOTIFICATION_TYPE.SCHEDULED_DEMO,
            USER_SCHEDULED_DEMO_STATUS_ACCEPT: enum_common_1.ENUM.NOTIFICATION_TYPE.SCHEDULED_DEMO,
        },
        TITLE: {
...
//# sourceMappingURL=notifications.common.js.map